...
**This challenge goes beyond the scope of what we have learned so far, so don't panic if you cannot figure it out based on the 2 labs**
...
- Syntax of for loops and printing in R (will be covered in the next lab)
