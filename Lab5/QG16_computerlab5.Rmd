...
- Create 100 samples from a normal distribution with a sample size of 50, $\mu = 0$, and $\sigma = 1$.
...
- Plot a histogram for the p-value distribution, and show the number of times where we reject the null hypothesis ( $\mu =0$ ) with a threshold of $\alpha = 0.05$ and print it out. Keep in mind that in this case we are testing if the mean is **different** from 0, not larger or smaller. 
